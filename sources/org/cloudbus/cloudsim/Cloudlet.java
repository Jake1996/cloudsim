...
public class Cloudlet {
	...
	private Cloudlet internalCloudlet;
	private Cloudlet parentCloudlet;
	public boolean isInternalCloudletProcessed;
	//public boolean isInternalCloudletProcessed = false;
	
	public Cloudlet getParentCloudlet() {
		return parentCloudlet;
	}


	public void setParent(Cloudlet parentCloudlet) {
		this.parentCloudlet = parentCloudlet;
	}


	public Cloudlet getInternalCloudlet() {
		return internalCloudlet;
	}


	public void setInternalCloudlet(Cloudlet internalCloudlet) {
		this.internalCloudlet = internalCloudlet;
		internalCloudlet.parentCloudlet = this;
		isInternalCloudletProcessed =false;
	}
	...
	/** Time at which the cloudlet must be processed (default = 0) */
	private double delay;
	
	/** returns the time at which the cloudlet should be submitted*/
	public double getDelay() {
		return delay;
	}

	/** Sets the delay in submitting the cloudlet */
