 ...
 */
public class CloudSimExampleNew2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			id++;
			Cloudlet inner_cloudlet = new Cloudlet(id, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
			inner_cloudlet.setUserId(brokerId);
		...
		for (int i = 0; i < size; i++) {
			...
			if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS){
				...
				Log.printLine( indent + indent + cloudlet.getResourceId() + indent + indent + indent + cloudlet.getVmId() +
						...
						indent + indent + dft.format(cloudlet.getFinishTime()) + indent + cloudlet.getSubmissionTime());
			}
		}
