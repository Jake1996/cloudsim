 ...
 */
public class CloudSimExampleNew1{
	...
	private static List<Cloudlet> createCloudlet(int userId, int cloudlets, int idShift,double delay)
	{
	...
	public static void main(String[] args) {
		...
		try {
			...
			DatacenterBroker broker0 = createBroker("Broker_0");
		//	DatacenterBroker broker1 = createBroker("Broker_1");
			...
			vmList = createVM(brokerId0, 2, 0); //creating 5 vms
			cloudletList = createCloudlet(brokerId0, 5, 0,0); // creating 10 cloudlets
		   ...
		   cloudletList=createCloudlet(brokerId0,5,200,5000);
		   ...
		   TotalCloudlets += cloudletList.size();
			...
			//newList.addAll(broker0.getBroker().getCloudletReceivedList());
